...
public class RoundedButtonUI extends BasicButtonUI { // custom button UI
    ...
    protected void paintButtonPressed(Graphics g, AbstractButton b) {
        ...
        g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); // smooth the edges for a better look
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        g2.fillRoundRect(0, 0, button.getWidth(), button.getHeight(), BORDER_RADIUS, BORDER_RADIUS); // set the border radius to the button
